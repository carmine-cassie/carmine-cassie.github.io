...
const accretion_disk = new THREE.TextureLoader().load('disk_texture_noisy.png');
const grav_lens = new EXRLoader().load('black_hole_uv6b.exr');
const stars = new THREE.TextureLoader().load('stars_distort.png');
